...
<body>
        ...
        <header class="header">
            <div class="inner-wrap">
                ...
                <div class="main-phone-block">
									<?if(new DateTime('09:00:00') < new DateTime() && new DateTime() < new DateTime('18:00:00')):?>
	...
	"demo", 
	array(
		"FORGOT_PASSWORD_URL" => "/s4/login/index.php?forgot_password=yes",
		"PROFILE_URL" => "/s4/login/user.php",
		"REGISTER_URL" => "/s4/login/index.php?register=yes",
		"SHOW_ERRORS" => "N",
