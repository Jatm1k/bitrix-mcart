...
<p><?=GetMessage('REVIEW_DOCUMENTS_TITLE')?></p>
<?if(count($arResult["DISPLAY_PROPERTIES"]['DOCUMENTS']['VALUE']) > 1):?>
	<?foreach($arResult["DISPLAY_PROPERTIES"]['DOCUMENTS']['FILE_VALUE'] as $file):?>
		<div class="exam-review-item-doc"><img class="rew-doc-ico" src="<?=SITE_TEMPLATE_PATH?>/img/icons/pdf_ico_40.png"><a download href="<?=$file['SRC']?>"><?=$file['ORIGINAL_NAME']?></a></div>
	<?endforeach;?>
<?else:?>
