...
<div class="site-section site-section-sm bg-light">
    ...
    <div class="row mb-5">
        ...
        <div class="site-section-title">
            <h2><?= GetMessage('AGENT_PAGE_TITLE') ?></h2>
        </div>
        </div>
    </div>
    <div class="mb-5">
                ...
                <div class="agent__card_item">
                    <div class="agent__card_info">
                        <div class="card__info_item">
                            <div class="position"><?= GetMessage('AGENT_MAIL_TITLE') ?></div>
                            <div class="name"><?= $arItem['UF_MAIL'] ?></div>
                        </div>
                        <div class="card__info_item">
                            <div class="position"><?= GetMessage('AGENT_PHONE_TITLE') ?></div>
                            <div class="name"><?= $arItem['UF_PHONE'] ?></div>
                        </div>
                        <div class="card__info_item">
                            <div class="position"><?= GetMessage('AGENT_KIND_OF_ACTIVITY_TITLE') ?></div>
                            <div class="name"><?= $arItem['UF_KIND_OF_ACTIVITY'] ?></div>
                        </div>
                    </div>
                </div>
